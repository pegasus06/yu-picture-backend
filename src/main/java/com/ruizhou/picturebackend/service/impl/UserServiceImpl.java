...
import static com.ruizhou.picturebackend.model.constant.UserConstant.USER_LOGIN_STATE;
...
UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        //校验是否重复
        QueryWrapper<User> account = new QueryWrapper<User>().eq("userAccount", userAccount);
        long count = baseMapper.selectCount(account);
        if (count > 0) {
