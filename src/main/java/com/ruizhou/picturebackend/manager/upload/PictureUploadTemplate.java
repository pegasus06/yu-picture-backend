package com.ruizhou.picturebackend.manager.upload;
    ...
    public final UploadPictureResult uploadPicture(Object inputSource, String uploadPathPrefix) {
        ...
        try {
            ...
            if (CollUtil.isNotEmpty(objectList)) {
                ...
                // 5. 封装压缩图返回结果
                CIObject thumbnailImage = objectList.get(1);
                // 封装压缩图返回结果
                return buildResult(originFilename, compressedCiObject, thumbnailImage);
            }
            // 封装原图返回结果
